...
public:
	static void setProfessionalTheme() {
		...
		// Colores de texto - blanco sobre negro
		colors[ImGuiCol_Text] = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
		colors[ImGuiCol_TextDisabled] = ImVec4(0.60f, 0.60f, 0.60f, 1.00f);

		// Fondos principales - negro
		colors[ImGuiCol_WindowBg] = ImVec4(0.08f, 0.08f, 0.08f, 1.00f);        // Negro principal
		colors[ImGuiCol_ChildBg] = ImVec4(0.10f, 0.10f, 0.10f, 1.00f);         // Ligeramente más claro
		colors[ImGuiCol_PopupBg] = ImVec4(0.06f, 0.06f, 0.06f, 0.98f);         // Más oscuro

		// Bordes - gris oscuro
		colors[ImGuiCol_Border] = ImVec4(0.25f, 0.25f, 0.25f, 0.80f);
		colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.30f);

		// Frames/Inputs - gris oscuro con hover rojo
		colors[ImGuiCol_FrameBg] = ImVec4(0.15f, 0.15f, 0.15f, 1.00f);
		colors[ImGuiCol_FrameBgHovered] = ImVec4(0.25f, 0.12f, 0.12f, 1.00f);   // Rojo oscuro
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.35f, 0.15f, 0.15f, 1.00f);    // Rojo más claro

		// Títulos de ventana - negro con borde
		...
		// Scrollbar
		colors[ImGuiCol_ScrollbarBg] = ImVec4(0.05f, 0.05f, 0.05f, 0.75f);
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.30f, 0.30f, 0.30f, 1.00f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.40f, 0.20f, 0.20f, 1.00f);  // Rojo
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.50f, 0.25f, 0.25f, 1.00f);   // Rojo más claro

		// Elementos interactivos - rojo como accent
		colors[ImGuiCol_CheckMark] = ImVec4(0.90f, 0.25f, 0.25f, 1.00f);       // Rojo
		colors[ImGuiCol_SliderGrab] = ImVec4(0.90f, 0.25f, 0.25f, 1.00f);      // Rojo
		colors[ImGuiCol_SliderGrabActive] = ImVec4(1.00f, 0.30f, 0.30f, 1.00f); // Rojo más brillante

		// Botones - gris con hover rojo
		colors[ImGuiCol_Button] = ImVec4(0.18f, 0.18f, 0.18f, 1.00f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.30f, 0.15f, 0.15f, 1.00f);    // Rojo oscuro
		colors[ImGuiCol_ButtonActive] = ImVec4(0.40f, 0.20f, 0.20f, 1.00f);     // Rojo

		// Headers
		colors[ImGuiCol_Header] = ImVec4(0.15f, 0.15f, 0.15f, 1.00f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.25f, 0.12f, 0.12f, 1.00f);    // Rojo oscuro
		colors[ImGuiCol_HeaderActive] = ImVec4(0.35f, 0.15f, 0.15f, 1.00f);     // Rojo

		// Separadores
		colors[ImGuiCol_Separator] = ImVec4(0.30f, 0.30f, 0.30f, 1.00f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.70f, 0.20f, 0.20f, 0.78f); // Rojo
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.90f, 0.25f, 0.25f, 1.00f);  // Rojo brillante
		...
		// Tabs con tonos azul oscuro
		colors[ImGuiCol_Tab] = ImVec4(0.11f, 0.11f, 0.21f, 1.00f);
		colors[ImGuiCol_TabHovered] = ImVec4(0.15f, 0.18f, 0.30f, 1.00f);
		colors[ImGuiCol_TabSelected] = ImVec4(0.09f, 0.09f, 0.19f, 1.00f);
		colors[ImGuiCol_TabSelectedOverline] = ImVec4(0.26f, 0.59f, 0.98f, 1.00f);
		colors[ImGuiCol_TabDimmed] = ImVec4(0.08f, 0.08f, 0.17f, 1.00f);
		colors[ImGuiCol_TabDimmedSelected] = ImVec4(0.10f, 0.10f, 0.18f, 1.00f);
		colors[ImGuiCol_TabDimmedSelectedOverline] = ImVec4(0.50f, 0.70f, 0.90f, 1.00f);

		// Docking
		colors[ImGuiCol_DockingPreview] = ImVec4(0.26f, 0.59f, 0.98f, 0.70f);
		colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.07f, 0.07f, 0.16f, 1.00f);
		...
		// Tablas con tonos azul oscuro
		colors[ImGuiCol_TableHeaderBg] = ImVec4(0.07f, 0.07f, 0.16f, 1.00f);
		colors[ImGuiCol_TableBorderStrong] = ImVec4(0.18f, 0.18f, 0.30f, 1.00f);
		colors[ImGuiCol_TableBorderLight] = ImVec4(0.12f, 0.12f, 0.22f, 1.00f);
		colors[ImGuiCol_TableRowBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
		colors[ImGuiCol_TableRowBgAlt] = ImVec4(0.15f, 0.15f, 0.25f, 0.25f);
		...
		// Configuración de estilo sin bordes redondeados
		...
		// Padding y espaciado más profesional
