...
public:
	static void setProfessionalTheme() {
		...
		colors[ImGuiCol_ChildBg] = ImVec4(0.38f, 0.37f, 0.34f, 1.00f);         // Un poco más claro
		colors[ImGuiCol_PopupBg] = ImVec4(0.30f, 0.30f, 0.28f, 0.98f);         // Un poco más oscuro
		...
		// Configuración de estilo para un look más profesional
