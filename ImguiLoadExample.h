...
int main() {
    ...
    while (g_running) {
        ...
        if (showDebugWindow) {
            ...
            ImGui::Separator();
            ImGui::Text("Mouse capturado: %s", mouseCaptured ? "S�" : "No");
            ...
            ImGui::Text("Ventanas");
            ImGui::Separator();
            ImGui::Checkbox("Mostrar informaci�n de c�mara", &showCameraInfo);
        ...
        // Ventana de informaci�n de c�mara
        if (showCameraInfo && activeScene->getCamera()) {
            ImGui::Begin("Informaci�n de C�mara", &showCameraInfo);
